...
Public Class CRReturnBook
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LibrarySystem.CRReturnBook.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRReturnBook
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRReturnBook = New CRReturnBook()
        rpt.Site = Me.Site
        Return rpt
    End Function
